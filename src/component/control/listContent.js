        ...
        <div className='container'>
          <div className='row'>
            ...
            <div style={{ textAlign: 'center', marginTop: '50px' }}>
              {this.props.page > 1 && <i className='fa fa-chevron-circle-left fa-20' onClick={this.props.prevPage} style={{ fontSize: '3em', color: '#750013' }} aria-hidden='true'></i>}
              &nbsp;&nbsp;&nbsp;
              <i className='fa fa-chevron-circle-right fa-6' onClick={this.props.nextPage} style={{ fontSize: '3em', color: '#750013'  }} aria-hidden='true'></i>
            </div>
